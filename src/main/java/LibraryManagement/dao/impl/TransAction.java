...
import LibraryManagement.exception.SqlConstraintException;
...
//			bPstmt.executeUpdate();  
	...
	private void closeUtil(Connection con, PreparedStatement bPstmt, PreparedStatement rPstmt , PreparedStatement bPstmt2) {
		try {
