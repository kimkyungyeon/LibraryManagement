...
//		list = new ArrayList<BookInfo>();
	...
	public String[] getColumnNames() {
		...
		return new String[] { "도서번호", "도서제목", "도서구분(번호)", "대출여부", "총권수", "현재권수" };
	}

	@Override
	protected void setAlignAndWidth() {
		setTableAlign(SwingConstants.CENTER, 0,1,2,3,4,5);
		setTableCellWidth(70,350,120,70,70,70);
	...
	public Object[] toArray(BookInfo t) {
		return new Object[] {
				t.getBookNo(), t.getBookTitle(), t.getCategoryNo().getBookCategory()+"("+t.getCategoryNo().getCategoryNo()+")", t.isRentYN(), t.getTotalcount(), t.getCount()
			};
	}
