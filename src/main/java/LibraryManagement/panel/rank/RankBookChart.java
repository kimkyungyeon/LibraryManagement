...
public class RankBookChart extends JPanel {
	public RankBookChart() {
...
//		List<MembInfo> memList = service.showMembInfoAll();
		rentCount = service.showRentInfoBookCount();
		for(RentInfo r : rentCount) {
			dataset.setValue(r.getCount(), "대여 횟수", r.getBookNo().getBookTitle());
		...
		Font axisF = new Font("Gulim", Font.PLAIN, 13);
